...
import org.netxms.nxmc.modules.agentmanagement.widgets.AgentConfigXmlEditor;
 ...
 */
public class AgentConfigXmlEditorView extends AdHocObjectView {
	private static final I18n i18n = LocalizationHelper.getI18n(AgentConfigXmlEditorView.class);

	private NXCSession session;
	private long nodeId;
	private AgentConfigXmlEditor editor;
	 ...
	 */
	public AgentConfigXmlEditorView(Node node) {
		super(i18n.tr("XML Editor"), ResourceManager.getImageDescriptor("icons/object-views/agent-config.png"),
				"AgentConfigXml", node.getObjectId(), false);
	...
	public void createContent(Composite parent) {
		editor = new AgentConfigXmlEditor(parent, SWT.NONE, SWT.H_SCROLL | SWT.V_SCROLL);
...
//		});
	...
	public void refresh() {
		if (modified) {
			if (!MessageDialogHelper.openQuestion(getWindow().getShell(), i18n.tr("Reload Content"), i18n.tr(
					"You have unsaved changes to configuration file. These changes will be lost after reload. Do you want to continue?")))
				return;
		}
